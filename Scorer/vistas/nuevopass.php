...
<head>
	...
	<form>
	<div><input type="password" name="pass1" id="passantiguo" placeholder="Ingrese su contraseña"></div>
	<div><input type="password" name="pass2" id="passnuevo" placeholder="Repita su contraseña"></div>
